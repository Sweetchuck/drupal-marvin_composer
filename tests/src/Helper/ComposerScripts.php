...
namespace Drupal\Tests\marvin_composer\Helper;
...
class ComposerScripts {
  ...
  protected function prepareProjectComposerJson() {
    $content = [
      'name' => 'drupal/marvin-composer-tests-project_01',
      'description' => 'drupal/marvin-composer-tests-project_01',
      "license" => "proprietary",
      'type' => 'drupal-project',
      'extra' => [
        'installer-types' => [
...
TEXT;
  ...
  protected function getProjectSelfFilesToSymlink(): array {
    ...
    $filesToSymLink = $extra['marvin_composer']['fixtures']['filesToSymlink'] ?? [];
